...
sub initialize {
  ...
  $self->{execfile}        = 'prog';
  $self->{default_options} = '-fprofile-arcs -ftest-coverage -Wextra -Wall -Wno-unused -pedantic -Wfloat-equal -Wshadow -std=c11 -lm -Wfatal-errors -fsanitize=alignment,undefined';
